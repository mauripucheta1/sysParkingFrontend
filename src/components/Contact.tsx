...
export default function Contact() {
  return (
    <section className="min-h-screen bg-white flex items-center py-16 px-6" id="contact">
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-10 space-y-4">
            ...
            >
              ...
              <span className="text-gray-700 text-lg">contact@yourclub.com</span>
            </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <input
              ...
              className="p-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#004DA4] bg-white"
            />
            <input
              type="text"
          ...
          <input
            ...
            className="mt-4 w-full p-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#004DA4] bg-white"
          />
          ...
          <button
            type="submit"
            className="mt-6 w-full py-3 rounded-xl text-white font-semibold bg-[#00A46D] hover:bg-[#008A5A] transition"
          >
            Send Message
          </button>
        </motion.form>
